...
<div class="fluid">
	...
	<form class="formElement" method="post" id="member_form" name="member_formEdit" target="myIframe" action="<?php echo DIR_ROOT?>member/backend/edit_team">
        <div class="widget">
            <!--<div class="formRow">
                <div class="grid2">
                ...
                <div class="grid2">
                    <input type="text" id="member_code" name="member_code" value="<?php echo $listEditTeam['member_code'];?>">
                </div>
            </div>
           	<div class="clear"></div>-->
            ...
            <div class="formRow">
                ...
                <div class="grid2">
                    <select id="member_type" name="member_type">
                    	<option value="1" <?php if($listEditTeam['member_type']==1) echo 'selected="seledted"'; ?>>เอเยนต์</option>
                    	<option value="2" <?php if($listEditTeam['member_type']==2) echo 'selected="seledted"'; ?>>สมาชิกขาจร</option>
                    	<option value="0" <?php if($listEditTeam['member_type']==0) echo 'selected="seledted"'; ?>>ลูกค้าของเอเยนต์</option>
                    </select>
                </div>
                
                <div class="grid2" id="boxParent">
                	<?php 
					if($listEditTeam['member_type']==0&&$listEditTeam['parent_id']!=0){
						$listParent = $this->model->listParent();
						echo '
						<select id="parent_id" name="parent_id">';
							if(!empty($listParent)){
								foreach($listParent as $list){
									echo '<option value="'.$list['member_id'].'"'; if($listEditTeam['parent_id']==$list['member_id']) echo 'selected="seledted"'; echo '>'.$list['member_first_name'].' '.$list['member_last_name'].'</option>';
								}
							}
						echo '</select>';
					}
            ...
            <div class="formRow">
                ...
                <div class="grid3" style="margin-top:7px;">
                    <strong><?php echo $listEditTeam['member_email'];?></strong>
                </div>
            </div>
           	<div class="clear"></div>
            ...
            <div class="formRow">
                ...
                <div class="grid3" style="margin-top:7px;">
                    <strong><?php echo base64_decode($listEditTeam['member_pass']);?></strong>
                </div>
            </div>
           	<div class="clear"></div>
            ...
            <div class="formRow">
                ...
                <div class="grid2">
                    <input type="text" id="member_first_name" name="member_first_name" value="<?php echo $listEditTeam['member_first_name'];?>">
                </div>
                <div class="grid2">
                    <input type="text" id="member_last_name" name="member_last_name" value="<?php echo $listEditTeam['member_last_name'];?>">
                </div>
            </div>
           	<div class="clear"></div>
            ...
            <div class="formRow">
                ...
                <div class="grid5">
                    <?php echo $this->bflibs->showSelectDay('member_birth_day',$listEditTeam['member_birth_day']);?>
                    <?php echo $this->bflibs->showSelectMonth('member_birth_month',$listEditTeam['member_birth_month']);?>
                    <?php echo $this->bflibs->showSelectYear('member_birth_year',$listEditTeam['member_birth_year']);?>
                </div>
            </div>
            ...
            <div class="formRow">
                ...
                <div class="grid3">
                    <input type="text" id="member_iden" name="member_iden" value="<?php echo $listEditTeam['member_iden'];?>">
                </div>
            </div>
           	<div class="clear"></div>
            ...
            <div class="formRow">
                ...
                <div class="grid2">
                    <input type="text" id="member_tel" name="member_tel" value="<?php echo $listEditTeam['member_tel'];?>">
                </div>
            </div>
           	<div class="clear"></div>
            ...
            <div class="formRow">
                ...
                <div class="grid5">
                    <textarea id="member_address" name="member_address" style="height:60px;"><?php echo $listEditTeam['member_address'];?></textarea>
                </div>
            </div>
            ...
            <div class="formRow">
                ...
                <div class="grid2">
                    <input type="text" id="member_discount" name="member_discount" value="<?php echo $listEditTeam['member_discount'];?>" onkeypress="return chkNumberOnly(event)" style="text-align:right; width:30px;">%
                </div>
            </div>
           	<div class="clear" style="height:5px;"></div> 
						...
						<div class="fl">
							<select id="member_occupation" name="member_occupation" style="width:195px;">
								...
								while($listOccupation = mysql_fetch_array($arr)){
									$sl = '';
									if($listEditTeam['member_occupation'] == $listOccupation['member_occupation_name']){
					...
					if($countData>0){
						...
						<select id="member_income" name="member_income" style="width:195px;">
							...
							while($listIncome = mysql_fetch_array($arr)){
								$sl = '';
								if($listEditTeam['member_income'] == $listIncome['member_income_name']){
									$sl = 'selected="selected"';
								}
            ...
            <div class="formRow">   
                <input type="hidden" id="parent_id" name="parent_id" value="<?php echo $listEditTeam['parent_id'];?>"></input>
                <input type="hidden" id="member_id" name="member_id" value="<?php echo $listEditTeam['member_id'];?>"></input>
	...
	$("#member_form").validate({
		rules: {
			...
			'member_email' : {
				required: true,
				//email: true,
				remote:DIR_ROOT+'member/frontend/chkDuplicateEmail/id/<?php echo $listEditTeam['member_id'];?>/'
			},
			'member_tel' : {
				required: true,
				number: true
