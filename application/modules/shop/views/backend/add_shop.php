...
<div class="fluid">
	...
	<form class="formElement" method="post" id="shop_form" name="shop_formAdd" target="myIframe" action="<?php echo DIR_ROOT?>shop/backend/add_shop">
        <div class="widget">
            ...
            <div class="formRow" id="boxCol">
                ...
                <div class="grid2">
                    ...
                    <div id="wrap_img" style="text-align:center;" class="wrap_img blank_img"><!--<img src="<?php echo DIR_PUBLIC?>images/icons/file/nofile.png" style="max-width:150px; max-height:150px;"/>--></div>
                    <div id="uploading" class="uploading" style="width:300px; height:250px; position:absolute; top:0px; display:none; "></div>
                ...
                <div class="grid12">
                    <fieldset>
                        ...
                        <div class="formRow">
                            ...
                            <div class="grid5">
                                <input type="text" id="shop_name[<?php echo $lang_id?>]" name="shop_name[<?php echo $lang_id?>]" >
                            </div>
                        </div>
                        <div class="clear"></div>
                        ...
                        <div class="formRow">
                            ...
                            <div class="grid9">
                                <textarea id="shop_detail[<?php echo $lang_id?>]" name="shop_detail[<?php echo $lang_id?>]" class="mceEditor"></textarea>
                            </div>
                        </div>
