...
<div class="fluid">
	...
	<form class="formElement" method="post" id="main_form" name="main_formEdit" target="myIframe" action="<?php echo DIR_ROOT?>main/backend/aboutus">
        <div class="widget">
			...
			<div class="formRow">
				<div class="grid2">
					<label class="lbl fl" for="main_aboutus[<?php echo $lang_id?>]">About us <?php echo $lang_icon;?></label>
				</div>
				<div class="grid9">
                    <textarea id="main_aboutus[<?php echo $lang_id?>]" name="main_aboutus[<?php echo $lang_id?>]" class="mceEditor"><?php echo $listEditMain['main_aboutus'][$lang_id];?></textarea>
				</div>
			</div>
