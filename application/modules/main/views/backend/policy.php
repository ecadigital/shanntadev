...
<div class="fluid">
	...
	<form class="formElement" method="post" id="main_form" name="main_formEdit" target="myIframe" action="<?php echo DIR_ROOT?>main/backend/policy">
        <div class="widget">
			
			<div class="formRow">
				<div class="grid2">
					<label class="lbl fl" for="main_policy">Policy</label>
				</div>
				<div class="grid9">
                    <textarea id="main_policy" name="main_policy" class="mceEditor"><?php echo $listEditMain['main_policy'];?></textarea>
				</div>
			</div>
