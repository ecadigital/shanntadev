...
<h3>หน้านโยบายการคืนเงิน</h3>
<div>
	<a href="<?php echo DIR_ROOT?>admin/admin/index">หน้าแรก</a>&nbsp;&nbsp;>&nbsp;&nbsp;
	จัดการหน้าอื่นๆ&nbsp;&nbsp;>&nbsp;&nbsp;
	หน้านโยบายการคืนเงิน
</div>
...
<div class="fluid">
	...
	<form class="formElement" method="post" id="main_form" name="main_formEdit" target="myIframe" action="<?php echo DIR_ROOT?>main/backend/refund">
        <div class="widget">
			...
			<div class="formRow">
				<div class="grid2">
					<label class="lbl fl" for="main_refund[<?php echo $lang_id?>]">ข้อความ <?php echo $lang_icon;?></label>
				</div>
				<div class="grid9">
                    <textarea id="main_refund[<?php echo $lang_id?>]" name="main_refund[<?php echo $lang_id?>]" class="mceEditor"><?php echo $listEditMain['main_refund'][$lang_id];?></textarea>
				</div>
			</div>
