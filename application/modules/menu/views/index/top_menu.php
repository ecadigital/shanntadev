...
<ul id="nav">
    <!--<li class="<?php echo $active_home;?>" style="width:40px;"><a href="<?php echo DIR_ROOT?>admin"><img src="<?php echo DIR_PUBLIC?>images/icons/color/home.png" height="20" /></a></li>
    ...
    <?php if($admin->admin_group<=2){?>
        <li class="sub <?php echo $active_member;?>" style="width:95px;"><a href="#"><img src="<?php echo DIR_PUBLIC?>images/icons/color/customers.png" height="20" /> สมาชิก</a>
            <ul>
    ...
    <li class="<?php echo $active_news;?>" style="width:130px;"><a href="<?php echo DIR_ROOT?>news/backend/index"><img src="<?php echo DIR_PUBLIC?>images/icons/color/world.png" height="20" /> ข่าวและอีเว้นท์</a>
