    ...
    <form class="formElement" method="post" id="collection_categories_form" name="collection_categories_formAdd" target="myIframe" action="<?php echo DIR_ROOT?>collection/backend/add_categories">
        <div class="widget">
			...
			<div class="formRow">
				...
				<div class="grid2">&nbsp;</div>
				<div class="grid5">
					<div class="txt_notify" style="margin-top:40px;margin-left:-20px;">* ขนาดรูปที่แนะนำคือ 132 x 140 พิกเซล</div>
				</div>
			</div>
			...
			?>			
				...
				<div class="formRow">
					...
					<div class="grid2">
						...
						<div id="wrap_img_banner_<?php echo $lang_id;?>" style="text-align:center;" class="wrap_img_banner blank_img"></div>
