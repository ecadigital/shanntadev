...
<h3>เพิ่มข้อมูลหมวดหมู่คอลเลคชั่น</h3>
<div>
...
<div class="fluid">
    ...
    <form class="formElement" method="post" id="collection_categories_form" name="collection_categories_formAdd" target="myIframe" action="<?php echo DIR_ROOT?>collection/backend/add_categories">
        <div class="widget">
            <!--<div class="formRow">
                <div class="grid2">
                    <label class="lbl fl" for="collection_categories_parent_id">หมวดหมู่คอลเลคชั่นหลัก</label>
                    ...
                    <select id="collection_categories_parent_id" name="collection_categories_parent_id" class="sep_bo">
						...
						if(!empty($listCategoriesParent)){
							foreach($listCategoriesParent as $list){
                        		echo '<option value="'.$list["collection_categories_id"].'" >'.$list["collection_categories_name"].'</option>';
            ...
            <div class="formRow">
                ...
                <div class="grid2">
					<div><input type="radio" name="collection_categories_home_position" id="collection_categories_home_positionL" value="L" checked="checked" />&nbsp;&nbsp;<label for="collection_categories_home_positionL">ซ้าย</label>&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="radio" name="collection_categories_home_position" id="collection_categories_home_positionC" value="C" />&nbsp;&nbsp;<label for="collection_categories_home_positionC">กลาง</label>&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="radio" name="collection_categories_home_position" id="collection_categories_home_positionR" value="R" />&nbsp;&nbsp;<label for="collection_categories_home_positionR">ขวา</label></div>
                </div>
                <div class="clear"></div>
                <div class="grid2">&nbsp;</div>
                <div class="grid5">
            ...
            <div class="formRow">
                ...
                <div class="grid2">
					<div><input type="radio" name="collection_categories_banner_position" id="collection_categories_banner_positionL" value="L" checked="checked" />&nbsp;&nbsp;<label for="collection_categories_banner_positionL">ซ้าย</label>&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="radio" name="collection_categories_banner_position" id="collection_categories_banner_positionC" value="C" />&nbsp;&nbsp;<label for="collection_categories_banner_positionC">กลาง</label>&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="radio" name="collection_categories_banner_position" id="collection_categories_banner_positionR" value="R" />&nbsp;&nbsp;<label for="collection_categories_banner_positionR">ขวา</label></div>
                </div>
                <div class="clear"></div>
                <div class="grid2">&nbsp;</div>
                <div class="grid5">
...
$(document).ready(function(){
	$("#collection_categories_form").validate({
	   ...
	   submitHandler: function(form) {
			document.collection_categories_formAdd.submit();
		}
	});
