	...
	<form class="formElement" method="post" id="collection_categories_form" name="collection_categories_formEdit" target="myIframe" action="<?php echo DIR_ROOT?>collection/backend/edit_categories">
        <div class="widget">
            ...
            <div class="formRow">
                ...
                <div class="grid3">
                    <input type="text" id="collection_categories_name" name="collection_categories_name" value="<?php echo $listEditCategories['collection_categories_name'];?>" >
                </div>
            </div>
            <div class="clear"></div>  
           	<div class="clear"></div>
            ...
            <div class="formRow">
                ...
                <div class="grid4">
                    <input type="text" id="collection_categories_home_keyhead" name="collection_categories_home_keyhead" value="<?php echo $listEditCategories['collection_categories_home_keyhead'];?>">
                </div>
            </div>   
           	<div class="clear"></div>
            <div class="formRow">
                ...
                <div class="grid4">
                    <textarea id="collection_categories_home_keymessage" name="collection_categories_home_keymessage" style="height:40px; width:389px;"><?php echo $listEditCategories['collection_categories_home_keymessage'];?></textarea>
                </div>
            </div>   
            ...
            <div class="formRow">
                ...
                <div class="grid4">
                    <input type="text" id="collection_categories_banner_keyhead" name="collection_categories_banner_keyhead" value="<?php echo $listEditCategories['collection_categories_banner_keyhead'];?>">
                </div>
            </div>   
           	<div class="clear"></div>
            <div class="formRow">
                ...
                <div class="grid4">
                    <textarea id="collection_categories_banner_keymessage" name="collection_categories_banner_keymessage" style="height:40px; width:389px;"><?php echo $listEditCategories['collection_categories_banner_keymessage'];?></textarea>
                </div>
            </div>   
           	<div class="clear" style="height:5px;"></div>
            <div class="formRow">
