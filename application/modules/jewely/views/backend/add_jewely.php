                ...
                <div class="grid12">
                    <fieldset>
						...
						<div class="formRow">
							...
							<div class="grid5">
								<input type="text" id="jewely_name[<?php echo $lang_id?>]" name="jewely_name[<?php echo $lang_id?>]">
							</div>
						</div>
						<div class="clear"></div>
						...
						<div class="formRow">
							...
							<div class="grid9">
								<textarea id="jewely_detail[<?php echo $lang_id?>]" name="jewely_detail[<?php echo $lang_id?>]" class="mceEditor"></textarea>
							</div>
						</div>
