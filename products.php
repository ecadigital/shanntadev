...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="content" class="row">
            <article class="small-6 large-4 columns products">
                <h1>JAZZ GLITZ STUD EARRING HEMATITE GREEN
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Omnis, tempora.
                </h1>
                <section class="small-10 columns small-centered">
                    <img src="<?php echo __images__; ?>/demo/product4.png" alt="">
                </section>
                <section class="small-12 columns priceTag">
                    <div class="small-6 columns"><b>10,680 THB</b></div>
                ...
                <section class="details">
                    <div class="medium-6 columns productDetailTrack">
                        <h1>JAZZ GLITZ Stud EARRING HEMATITE GREEN 1</h1>
                        <div class="inner">Rihodium plated brass statement earring adomed with eye-catching Hematites, Lapis and Fang details. Hermaltite plated earring</div>
                        <hr class="dotted">
            ...
            <article class="small-6 large-4 columns products">
                <h1>JAZZ GLITZ STUD EARRING HEMATITE GREEN</h1>
                <section class="small-10 columns small-centered">
                    <img src="<?php echo __images__; ?>/demo/product4.png" alt="">
                </section>
                <section class="small-12 columns priceTag">
                    <div class="small-6 columns"><b>10,680 THB</b></div>
                    <div class="small-6 columns"><a class="addToCart" href="#"><i class="fa fa-shopping-cart"></i> <b>ADD TO CART</b></a></div>
                </section>
                <section class="details">
                    <div class="medium-6 columns productDetailTrack">
                        <h1>JAZZ GLITZ Stud EARRING HEMATITE GREEN 2</h1>
                        <div class="inner">Rihodium plated brass statement earring adomed with eye-catching Hematites, Lapis and Fang details. Hermaltite plated earring</div>
                        <hr class="dotted">
                        <div class="medium-6 large-8 columns price">
                            1,680 <b>THB</b>
            ...
            <article class="small-6 large-4 columns end products">
                ...
                <section class="details">
                    <div class="medium-6 columns productDetailTrack">
                        <h1>JAZZ GLITZ Stud EARRING HEMATITE GREEN 3</h1>
                        <div class="inner">Rihodium plated brass statement earring adomed with eye-catching Hematites, Lapis and Fang details. Hermaltite plated earring</div>
                        <hr class="dotted">
                        <div class="medium-6 large-8 columns price">
                            1,680 <b>THB</b>
